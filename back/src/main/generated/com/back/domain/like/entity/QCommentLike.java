...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    private static final long serialVersionUID = 156993906L;
    ...
    public final com.back.domain.comment.entity.QComment comment;
    ...
    public QCommentLike(Class<? extends CommentLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.comment = inits.isInitialized("comment") ? new com.back.domain.comment.entity.QComment(forProperty("comment"), inits.get("comment")) : null;
