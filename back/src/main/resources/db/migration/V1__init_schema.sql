...
CREATE TABLE scenarios (
    ...
    decision_line_id BIGINT NOT NULL,
    post_id BIGINT,
    user_id BIGINT NOT NULL
);
...
ALTER TABLE poll_votes ADD CONSTRAINT uq_anonymous_once UNIQUE (post_id, poll_uid, user_hash);
...
ALTER TABLE scenarios ADD CONSTRAINT fk_scenarios_post FOREIGN KEY (post_id) REFERENCES post(id);
